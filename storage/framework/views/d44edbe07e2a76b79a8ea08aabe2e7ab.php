          ...
          <tbody>
            ...
            <?php $__currentLoopData = $menus['roles']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <tr>
                  ...
                  <td><input type="checkbox" class="menu_checkbox" name="menuname" for="menu" onclick="return menucheckboxes('<?php echo e($menu->Name); ?>', this.checked)" ><?php echo e($menu->Name); ?></td>
                ...
                { ?>
                  <tr>
                    ...
                    ?>
                    <td><input type="checkbox"  name="data[<?php echo e($menu->id); ?>][<?php echo e($submenu->id); ?>][add]" value="1" class="submenu_checkbox"></td>
                     <td><input type="checkbox" name="data[<?php echo e($menu->id); ?>][<?php echo e($submenu->id); ?>][edit]" value="1" class="submenu_checkbox"></td>
                     <td><input type="checkbox" name="data[<?php echo e($menu->id); ?>][<?php echo e($submenu->id); ?>][delete]" value="1" class="submenu_checkbox"></td>
                    <td><input type="checkbox" name="data[<?php echo e($menu->id); ?>][<?php echo e($submenu->id); ?>][view]" value="1" class="submenu_checkbox"></td>
              </tr>
...
<script>
  ...
  // Get submenu checkboxes
  const submenuCheckboxes = document.querySelectorAll('.submenu_checkbox');
  
  // Add event listener to submenu checkboxes
  submenuCheckboxes.forEach(function(checkbox) {
    checkbox.addEventListener('change', function() {
      // Check menu checkbox if any submenu checkbox is checked
      let submenuChecked = false;
      submenuCheckboxes.forEach(function(submenuCheckbox) {
        if (submenuCheckbox.checked) {
          submenuChecked = true;
        }
      });
      menuCheckbox.checked = submenuChecked;
    });
  });
</script>
