          ...
          // dd($data);
            ...
            ?>
                <tr>
                  ...
                  <td><input type="checkbox" id="<?php echo e($menu->Name); ?>" name="menuname" for="menu" onclick="return menucheckboxes('<?php echo e($menu->Name); ?>', this.checked)" ><?php echo e($menu->Name); ?></td>
                ...
                { ?>
                  ...
                  <tr>
                    ...
                    <td><input type="checkbox" onclick="return submenucheckbox('<?php echo e($menu->Name); ?>', this.checked)" name="data[<?php echo e($menu->id); ?>][<?php echo e($submenu->id); ?>][add]" value="1" class="<?php echo e($menu->Name); ?>"></td>
                     <td><input type="checkbox" onclick="return submenucheckbox('<?php echo e($menu->Name); ?>', this.checked)" name="data[<?php echo e($menu->id); ?>][<?php echo e($submenu->id); ?>][edit]" value="1" class="<?php echo e($menu->Name); ?>"></td>
                     <td><input type="checkbox" onclick="return submenucheckbox('<?php echo e($menu->Name); ?>', this.checked)" name="data[<?php echo e($menu->id); ?>][<?php echo e($submenu->id); ?>][delete]" value="1" class="<?php echo e($menu->Name); ?>"></td>
                    <td><input type="checkbox" onclick="return submenucheckbox('<?php echo e($menu->Name); ?>', this.checked)" name="data[<?php echo e($menu->id); ?>][<?php echo e($submenu->id); ?>][view]" value="1" class="<?php echo e($menu->Name); ?>"></td>
              </tr>
...
</htm><?php /**PATH C:\xampp\htdocs\sai_fitness\resources\views/auth/roles.blade.php ENDPATH**/ ?>