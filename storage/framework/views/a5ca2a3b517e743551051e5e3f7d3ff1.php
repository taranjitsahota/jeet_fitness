                ...
                { ?>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <input type="checkbox" class="submenu" name="data[<?php echo e($menu->id); ?>][<?php echo e($submenu->id); ?>][add]" value="1" checked class="<?php echo e($menu->Name); ?>">
                      <?php else: ?>
                      <input type="checkbox" class="submenu" name="data[<?php echo e($menu->id); ?>][<?php echo e($submenu->id); ?>][add]" value="1" class="<?php echo e($menu->Name); ?>">
                      <?php endif; ?>
                    </td>
                     <td>
                      <?php if($edit[$submenu->id] == 1): ?>
                      <input type="checkbox" name="data[<?php echo e($menu->id); ?>][<?php echo e($submenu->id); ?>][edit]" value="1" checked class="<?php echo e($menu->Name); ?>">
                      <?php else: ?>
                      <input type="checkbox" name="data[<?php echo e($menu->id); ?>][<?php echo e($submenu->id); ?>][edit]" value="1" class="<?php echo e($menu->Name); ?>">
                      <?php endif; ?>
                    </td>
                     <td>
                      <?php if($delete[$submenu->id] == 1): ?>
                      <input type="checkbox" name="data[<?php echo e($menu->id); ?>][<?php echo e($submenu->id); ?>][delete]" value="1" checked class="<?php echo e($menu->Name); ?>">
                      <?php else: ?>
                      <input type="checkbox" name="data[<?php echo e($menu->id); ?>][<?php echo e($submenu->id); ?>][delete]" value="1" class="<?php echo e($menu->Name); ?>">
                      <?php endif; ?>
                    </td>
                    <td>
                      <?php if($view[$submenu->id] == 1): ?>
                      <input type="checkbox" name="data[<?php echo e($menu->id); ?>][<?php echo e($submenu->id); ?>][view]" value="1" checked class="<?php echo e($menu->Name); ?>">
                      <?php else: ?>
                      <input type="checkbox" name="data[<?php echo e($menu->id); ?>][<?php echo e($submenu->id); ?>][view]" value="1" class="<?php echo e($menu->Name); ?>">
                      <?php endif; ?>
                    </td>
                  </tr>
                  <?php endif; ?>
