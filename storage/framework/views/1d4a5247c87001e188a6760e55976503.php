            ...
            <?php $__currentLoopData = $menus['roles']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                { ?>
                  <tr>
                    ...
                    ?>
                    <td><input type="checkbox"  name="data[<?php echo e($menu->id); ?>][<?php echo e($submenu->id); ?>][add]" value="1" class="<?php echo e($menu->Name); ?>"></td>
...
<?php /**PATH C:\xampp\htdocs\jeet_fitness\resources\views/auth/roles.blade.php ENDPATH**/ ?>